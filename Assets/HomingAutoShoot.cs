...
public class HomingAutoShoot : AutoShoot
{
    protected override void Start()
    {
        levelToBulletStartOffset = new List<List<Vector3>>() {
        new List<Vector3>() { new Vector3(0.5f,0,0) },
        new List<Vector3>() { new Vector3(0.5f,0,0) ,new Vector3(-0.5f,0,0) },
